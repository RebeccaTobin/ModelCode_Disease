...
namespace Parameters {
    ...
    double tau;  // Length of time after node of interest is damaged to wait before repairing it 1 -> 0
    int repair_k;  // id of node to be repaired and tracked in "Rates..." file
...
void SetParameters(int argc, char *argv[]) {
    ...
    // disease parameters
    tau = atof(argv[16]); std::cout << ", tau: " << tau;
    repair_k = atoi(argv[17]); std::cout << ", repair_k: " << repair_k;
