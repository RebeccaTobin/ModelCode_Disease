...
namespace Parameters {
    ...
    double RateIncrease; // fractional increase in Gamma0 during disease
    double StartTime;  // at what age the disease starts
...
void SetParameters(int argc, char *argv[]) {
    ...
    // disease parameters
    RateIncrease = atof(argv[16]); std::cout << ", RateIncrease: " << RateIncrease;
    StartTime = atof(argv[17]); std::cout << ", StartTime: " << StartTime;
    tau = atof(argv[18]); std::cout << ", tau: " << tau;
    EndTime = StartTime + tau;
    
    Tag = atoi(argv[19]); std::cout << ", Tag: " << Tag;
